...
export class EditdialogComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) private data: [Smena, number],
  ...
  ngOnInit(): void {
    this.firstName.setValue(this.data[0].FIO);
    this.startDate.setValue(this.data[0].startDate);
    this.endDate.setValue(this.data[0].endDate);
  ...
  public onSubmit(): void {
    ...
    this.shiftServiceService.edit(shift)
      .subscribe(() => {
        this.registrationForm.reset();
        this.alertService.success('Смена была отредактированна');
